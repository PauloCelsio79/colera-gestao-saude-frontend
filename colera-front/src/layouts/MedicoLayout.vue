  ...
  <div class="min-h-screen bg-secondary-900">
    ...
    <aside class="fixed inset-y-0 left-0 w-64 bg-secondary-800 text-white transition-transform duration-300 transform">
      <div class="flex items-center justify-center h-20 bg-secondary-900">
        <h1 class="text-2xl font-bold text-primary-500">Painel Médico</h1>
      </div>
      <nav class="mt-6 px-4">
        <router-link 
...
const menuItems = [
  { name: 'Pacientes', path: '/dashboard/medico/pacientes', icon: UserGroupIcon },
  { name: 'Triagens', path: '/dashboard/medico/triagens', icon: ClipboardDocumentListIcon },
  { name: 'Encaminhamentos', path: '/dashboard/medico/encaminhamentos', icon: TruckIcon },
]
